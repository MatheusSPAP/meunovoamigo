...
CREATE TABLE IF NOT EXISTS `modelagemanimaisadocao`.`raca` (
  ...
  PRIMARY KEY (`idraca`, `tipo_idtipo_animal`),
...
CREATE TABLE IF NOT EXISTS `modelagemanimaisadocao`.`animal` (
  ...
  PRIMARY KEY (`idAnimal`, `fk_idusuario`, `fk_idstatus`, `tipo_idtipo_animal`, `tamanho_animal_idtamanho_animal`, `comportamento_idcomportamento`),
  ...
  INDEX `fk_animal_raca` (`fk_idraca` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `modelagemanimaisadocao`.`interesse_adocao` (
  ...
  `usuario_idusuario` INT NOT NULL,
  `animal_idAnimal` INT NOT NULL,
  `animal_fk_idusuario` INT NOT NULL,
  `animal_fk_idstatus` INT NOT NULL,
  PRIMARY KEY (`idinteresse_adocao`, `usuario_idusuario`, `animal_idAnimal`, `animal_fk_idusuario`, `animal_fk_idstatus`),
  INDEX `fk_interesse_adocao_usuario1_idx` (`usuario_idusuario` ASC) VISIBLE,
  INDEX `fk_interesse_adocao_animal1_idx` (`animal_idAnimal` ASC, `animal_fk_idusuario` ASC, `animal_fk_idstatus` ASC) VISIBLE,
  CONSTRAINT `fk_interesse_adocao_animal1`
    FOREIGN KEY (`animal_idAnimal` , `animal_fk_idusuario` , `animal_fk_idstatus`)
    REFERENCES `modelagemanimaisadocao`.`animal` (`idAnimal` , `fk_idusuario` , `fk_idstatus`),
